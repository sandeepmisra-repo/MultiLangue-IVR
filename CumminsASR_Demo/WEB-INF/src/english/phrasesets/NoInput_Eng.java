 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:23:44 PM
 */
public class NoInput_Eng extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoInput_Eng
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoInput_Eng", "NoInput.wav", ""); 

		// phrase: NoInput_Eng_New
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoInput_Eng_New", "NoInput_Eng.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoInput_Eng.PHRASE_MAP, phraseName));
	}
}
