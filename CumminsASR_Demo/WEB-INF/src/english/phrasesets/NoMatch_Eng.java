 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:25:14 PM
 */
public class NoMatch_Eng extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoMatch_Eng
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoMatch_Eng", "NoMatch.wav", ""); 

		// phrase: NoMatch_Eng_New
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoMatch_Eng_New", "NoMatch_Eng.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoMatch_Eng.PHRASE_MAP, phraseName));
	}
}
