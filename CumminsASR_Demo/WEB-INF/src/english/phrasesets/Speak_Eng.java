 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:57:38 PM
 */
public class Speak_Eng extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: WWID_Eng
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "WWID_Eng", "WWID.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Speak_Eng.PHRASE_MAP, phraseName));
	}
}
