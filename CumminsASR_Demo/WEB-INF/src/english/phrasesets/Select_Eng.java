 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:04:20 PM
 */
public class Select_Eng extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: Select_Eng
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Select_Eng", "Select_Eng.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Select_Eng.PHRASE_MAP, phraseName));
	}
}
