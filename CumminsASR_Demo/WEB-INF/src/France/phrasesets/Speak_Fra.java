 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:58:37 PM
 */
public class Speak_Fra extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: WWID_Fra
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "WWID_Fra", "WWID_Fra.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Speak_Fra.PHRASE_MAP, phraseName));
	}
}
