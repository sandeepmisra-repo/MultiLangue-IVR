 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:05:16 PM
 */
public class Select_Fra extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: Select_Fra
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Select_Fra", "Select_Fra.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Select_Fra.PHRASE_MAP, phraseName));
	}
}
