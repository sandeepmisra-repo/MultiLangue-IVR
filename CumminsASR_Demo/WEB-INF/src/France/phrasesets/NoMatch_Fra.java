 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:51:21 PM
 */
public class NoMatch_Fra extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoMatch_Fra
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoMatch_Fra", "NoMatch_Fra.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoMatch_Fra.PHRASE_MAP, phraseName));
	}
}
