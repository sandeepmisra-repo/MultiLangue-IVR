 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  05:31:50 PM
 */
public class OutTTS_Fra extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: YouHaveEntered_Fra
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "YouHaveEntered_Fra", "YouHaveEntered_Fra.wav", ""); 

		// phrase: Confirm_Fra
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Confirm_Fra", "Confirm_Fra.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(OutTTS_Fra.PHRASE_MAP, phraseName));
	}
}
