...
public interface IProjectVariables {
	...
	public static final String LANGUAGE_TO_ASR = "LanguageToASR";
	...
	public static final String LANGUAGE_NAME_TO_TTS = "LanguageNameToTTS";
	...
	public static final String WELCOME_ALL = "WelcomeAll";
	public static final String TIME = "time";
	public static final String LANGUAGE_CODE_TO_TTS = "LanguageCodeToTTS";
	...
	public static final String CONFIRM_FIELD_CONFIDENCE = "confidence";
	public static final String CONFIRM_FIELD_INPUTMODE = "inputmode";
	public static final String CONFIRM_FIELD_INTERPRETATION = "interpretation";
	public static final String CONFIRM_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CONFIRM_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CONFIRM_FIELD_UTTERANCE = "utterance";
	public static final String CONFIRM_FIELD_VALUE = "value";
	public static final String SELECT_ALL_FIELD_CONFIDENCE = "confidence";
	public static final String SELECT_ALL_FIELD_INPUTMODE = "inputmode";
	public static final String SELECT_ALL_FIELD_INTERPRETATION = "interpretation";
	public static final String SELECT_ALL_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SELECT_ALL_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SELECT_ALL_FIELD_UTTERANCE = "utterance";
	public static final String SELECT_ALL_FIELD_VALUE = "value";
	public static final String RECORD_FIELD_CONFIDENCE = "confidence";
	public static final String RECORD_FIELD_DURATION = "duration";
	public static final String RECORD_FIELD_MAXTIME = "maxtime";
	public static final String RECORD_FIELD_SIZE = "size";
	public static final String RECORD_FIELD_TERMCHAR = "termchar";
	public static final String RECORD_FIELD_UTTERANCE = "utterance";
	public static final String RECORD_FIELD_VALUE = "value";
	...
	public static final String WELCOME_ALL_FIELD_CONFIDENCE = "confidence";
	public static final String WELCOME_ALL_FIELD_INPUTMODE = "inputmode";
	public static final String WELCOME_ALL_FIELD_INTERPRETATION = "interpretation";
	public static final String WELCOME_ALL_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String WELCOME_ALL_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String WELCOME_ALL_FIELD_UTTERANCE = "utterance";
	public static final String WELCOME_ALL_FIELD_VALUE = "value";
