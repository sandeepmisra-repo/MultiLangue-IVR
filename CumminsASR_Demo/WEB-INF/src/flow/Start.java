 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2019-JUL-03  03:38:15 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.LANGUAGE_TO_ASR, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.CONFIRM_FIELD_CONFIDENCE,
			IProjectVariables.CONFIRM_FIELD_INPUTMODE,
			IProjectVariables.CONFIRM_FIELD_INTERPRETATION,
			IProjectVariables.CONFIRM_FIELD_NOINPUTCOUNT,
			IProjectVariables.CONFIRM_FIELD_NOMATCHCOUNT,
			IProjectVariables.CONFIRM_FIELD_UTTERANCE,
			IProjectVariables.CONFIRM_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CONFIRM, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.SELECT_ALL_FIELD_CONFIDENCE,
			IProjectVariables.SELECT_ALL_FIELD_INPUTMODE,
			IProjectVariables.SELECT_ALL_FIELD_INTERPRETATION,
			IProjectVariables.SELECT_ALL_FIELD_NOINPUTCOUNT,
			IProjectVariables.SELECT_ALL_FIELD_NOMATCHCOUNT,
			IProjectVariables.SELECT_ALL_FIELD_UTTERANCE,
			IProjectVariables.SELECT_ALL_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.SELECT_ALL, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.URL, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.LANGUAGE_NAME_TO_TTS, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.RECORD_FIELD_CONFIDENCE,
			IProjectVariables.RECORD_FIELD_DURATION,
			IProjectVariables.RECORD_FIELD_MAXTIME,
			IProjectVariables.RECORD_FIELD_SIZE,
			IProjectVariables.RECORD_FIELD_TERMCHAR,
			IProjectVariables.RECORD_FIELD_UTTERANCE,
			IProjectVariables.RECORD_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.RECORD, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SELECTED_LANGUAGE, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.WELCOME_ALL_FIELD_CONFIDENCE,
			IProjectVariables.WELCOME_ALL_FIELD_INPUTMODE,
			IProjectVariables.WELCOME_ALL_FIELD_INTERPRETATION,
			IProjectVariables.WELCOME_ALL_FIELD_NOINPUTCOUNT,
			IProjectVariables.WELCOME_ALL_FIELD_NOMATCHCOUNT,
			IProjectVariables.WELCOME_ALL_FIELD_UTTERANCE,
			IProjectVariables.WELCOME_ALL_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.WELCOME_ALL, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.LANGUAGE_CODE_TO_TTS, "", null, session, false, false );
		session.putVariable(variable);
