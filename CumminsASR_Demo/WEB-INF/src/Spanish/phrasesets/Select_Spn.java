 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:03:34 PM
 */
public class Select_Spn extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: Select_Spn
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Select_Spn", "Select_Spn.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Select_Spn.PHRASE_MAP, phraseName));
	}
}
