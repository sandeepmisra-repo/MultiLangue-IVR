 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:21:00 PM
 */
public class NoInput_Spn extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoInput_Spn
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoInput_Spn", "NoInput_Spn.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoInput_Spn.PHRASE_MAP, phraseName));
	}
}
