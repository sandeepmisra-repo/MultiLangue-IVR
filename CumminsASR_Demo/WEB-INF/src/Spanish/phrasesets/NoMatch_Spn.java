 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:53:21 PM
 */
public class NoMatch_Spn extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoMatch_Spn
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoMatch_Spn", "NoMatch_Spn.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoMatch_Spn.PHRASE_MAP, phraseName));
	}
}
