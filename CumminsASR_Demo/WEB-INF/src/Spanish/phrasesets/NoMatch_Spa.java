 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:16:29 PM
 */
public class NoMatch_Spa extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoInput_Spa
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoInput_Spa", "NoInput_Spn.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoMatch_Spa.PHRASE_MAP, phraseName));
	}
}
