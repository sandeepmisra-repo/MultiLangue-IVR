 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:56:24 PM
 */
public class Speak_Spn extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: WWID_Spn
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "WWID_Spn", "WWID.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Speak_Spn.PHRASE_MAP, phraseName));
	}
}
