 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:12:56 PM
 */
public class Select extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: Select_Ger
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "Select_Ger", "Select_Ger.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Select.PHRASE_MAP, phraseName));
	}
}
