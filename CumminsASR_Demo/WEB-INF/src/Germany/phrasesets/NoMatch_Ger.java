 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2019-JUL-03  04:52:24 PM
 */
public class NoMatch_Ger extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: NoMatch_Ger
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "NoMatch_Ger", "NoMatch_Ger.wav", ""); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(NoMatch_Ger.PHRASE_MAP, phraseName));
	}
}
